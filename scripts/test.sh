...
set -eu
cd "$(dirname "$0")/.."
for test in tests/arcade.lua tests/invaders.lua tests/invaders_audio.lua tests/setup.lua tests/modes.lua tests/theme.lua tests/terminal.lua tests/terminal_cells.lua; do
