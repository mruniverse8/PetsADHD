...
**VS Code:** [download the VSIX](dist/PetsADHD-0.3.6.vsix), then run **Extensions:
...
In VS Code, **a** breathes fire and **w** cycles sun, rain, sunset, and automatic
weather. Pets now walk across the terminal width.
