...
**VS Code:** [download the VSIX](dist/PetsADHD-0.3.7.vsix), then run **Extensions:
...
pixel size, and **a** breathes fire. Pets walk beneath a permanent night sky with
stars, Saturn, and a galaxy.
